...
class Account extends CI_Controller {
    ...
    function loginForm() {
            if(isset($_SESSION['user'])){
    			redirect('arcade/index'); //redirect to the main application page
    		}else{ 
    ...
    function createNew() {
	    	...
	    	$this->form_validation->set_rules("verify", "Captcha", "required|callback_verifyimage");
	    	$this->form_validation->set_message('verifyimage', 'unmatched value for %s.');
    ...
    function updatePasswordForm() {
        if(!isset($_SESSION['user'])){
    		...
    		$this->load->view('header',array("title"=>'Update Password'));
    ...
    function recoverPasswordForm() {
        if(isset($_SESSION['user'])){
    		...
    		$this->load->view('header',array("title"=>'Recover Password'));
